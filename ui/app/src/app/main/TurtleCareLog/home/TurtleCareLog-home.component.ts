...
@Component({
  selector: 'TurtleCareLog-home',
  templateUrl: './TurtleCareLog-home.component.html',
  styleUrls: ['./TurtleCareLog-home.component.scss']
})
export class TurtleCareLogHomeComponent implements AfterViewInit {
