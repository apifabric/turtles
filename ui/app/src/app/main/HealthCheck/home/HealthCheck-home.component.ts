...
@Component({
  selector: 'HealthCheck-home',
  templateUrl: './HealthCheck-home.component.html',
  styleUrls: ['./HealthCheck-home.component.scss']
})
export class HealthCheckHomeComponent implements AfterViewInit {
