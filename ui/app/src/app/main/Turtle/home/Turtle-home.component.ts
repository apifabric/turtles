...
@Component({
  selector: 'Turtle-home',
  templateUrl: './Turtle-home.component.html',
  styleUrls: ['./Turtle-home.component.scss']
})
export class TurtleHomeComponent implements AfterViewInit {
