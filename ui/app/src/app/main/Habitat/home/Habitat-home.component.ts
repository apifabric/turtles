...
@Component({
  selector: 'Habitat-home',
  templateUrl: './Habitat-home.component.html',
  styleUrls: ['./Habitat-home.component.scss']
})
export class HabitatHomeComponent implements AfterViewInit {
