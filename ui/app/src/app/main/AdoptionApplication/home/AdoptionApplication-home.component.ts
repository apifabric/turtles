...
@Component({
  selector: 'AdoptionApplication-home',
  templateUrl: './AdoptionApplication-home.component.html',
  styleUrls: ['./AdoptionApplication-home.component.scss']
})
export class AdoptionApplicationHomeComponent implements AfterViewInit {
