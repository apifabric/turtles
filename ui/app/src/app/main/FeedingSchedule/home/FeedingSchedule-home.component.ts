...
@Component({
  selector: 'FeedingSchedule-home',
  templateUrl: './FeedingSchedule-home.component.html',
  styleUrls: ['./FeedingSchedule-home.component.scss']
})
export class FeedingScheduleHomeComponent implements AfterViewInit {
