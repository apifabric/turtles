...
@Component({
  selector: 'ResearchProject-home',
  templateUrl: './ResearchProject-home.component.html',
  styleUrls: ['./ResearchProject-home.component.scss']
})
export class ResearchProjectHomeComponent implements AfterViewInit {
