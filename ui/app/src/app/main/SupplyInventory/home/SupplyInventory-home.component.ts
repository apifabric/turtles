...
@Component({
  selector: 'SupplyInventory-home',
  templateUrl: './SupplyInventory-home.component.html',
  styleUrls: ['./SupplyInventory-home.component.scss']
})
export class SupplyInventoryHomeComponent implements AfterViewInit {
